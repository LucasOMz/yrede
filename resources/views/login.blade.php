              ...
              <form class="space-y-4 md:space-y-6" action="/logar" method="POST">
                @csrf
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Don’t have an account yet? <a href="http://127.0.0.1:8000/cadastra-usuario" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign up</a>
                  </p>
              </form>
          </div>
      </div>
